# -----------------------------------------------------------------------------
# Reference: https://github.com/microsoft/X-Decoder/blob/v2.0/datasets/build.py
...
def build_eval_dataloader(cfg, ):
    ...
    for dataset_name in cfg['DATASETS']['TEST']:
        ...
        #     mapper = RefCOCODenseDatasetMapper(cfg, False)
        else:
            mapper = None
...
def build_train_dataloader(cfg, ):
    ...
    for dataset_name in dataset_names:
        ...
        if mapper_name == "coco_panoptic_densecap":
            mapper = COCOPanopticDensecapDatasetMapper(cfg, True)
...
def build_evaluator(cfg, dataset_name, output_folder=None):
    ...
    # mask caption
    if evaluator_type == "caption_seg":
        evaluator_list.append(CaptionEvaluator(dataset_name, output_dir=output_folder))
