# ---------------------------------------------------------------------
# Reference: https://github.com/microsoft/X-Decoder/blob/v2.0/entry.py
...
def init_wandb(args, job_dir, entity='yzy12468', project='pix2cap', job_name='tmp'):
...
def main(args=None):
    ...
    if opt['TRAINER'] == 'pix2cap':
        from trainer import Pix2Cap_Trainer as Trainer
    else:
